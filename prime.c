...
/******************************************************************************/
/*
  Program untuk menetukan banyaknya bilangan prima dari rentang 1 sampai ke - N
*/
{
  int id;
  int ierr;
...
*/
  ...
  if ( id == 0 )
  {
    printf("  Waktu program dimulai : ");
    timestamp ( );
    printf ( "\n" );
    printf ( "PRIME_MPI\n" );
    printf ( "  C/MPI version\n" );
    printf ( "\n" );
    printf ( "  PROGRAM MENGHITUNG BILANGAN PRIMA DENGAN MPI.\n" );
    printf ( "  Banyak Proses yang Digunakan :  %d\n", p );
    printf ( "\n" );
    printf ( "         N       Prima          Waktu\n" );
    printf ( "\n" );
  }
